...
{
    // m_timestamp_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1a5a4e19
    m_timestamp_ = 0;
    // m_timestamp_sample_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7068e664
    m_timestamp_sample_ = 0;
    // m_device_id_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@60db1c0e
    m_device_id_ = 0;
    // m_pixel_flow com.eprosima.idl.parser.typecode.AliasTypeCode@3e78b6a5
    memset(&m_pixel_flow, 0, (2) * 4);
    // m_delta_angle com.eprosima.idl.parser.typecode.AliasTypeCode@769a1df5
    memset(&m_delta_angle, 0, (3) * 4);
    // m_delta_angle_available_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@41f69e84
    m_delta_angle_available_ = false;
    // m_distance_m_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7975d1d8
    m_distance_m_ = 0.0;
    // m_distance_available_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2438dcd
    m_distance_available_ = false;
    // m_integration_timespan_us_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@24105dc5
    m_integration_timespan_us_ = 0;
    // m_quality_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5167f57d
    m_quality_ = 0;
    // m_error_count_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@64b0598
    m_error_count_ = 0;
    // m_max_flow_rate_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@18f8cd79
    m_max_flow_rate_ = 0.0;
    // m_min_ground_distance_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3e2055d6
    m_min_ground_distance_ = 0.0;
    // m_max_ground_distance_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@50029372
    m_max_ground_distance_ = 0.0;
    // m_mode_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@e3b3b2f
    m_mode_ = 0;
