...
{
    // m_timestamp_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2ef3eef9
    m_timestamp_ = 0;
    // m_type_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@243c4f91
    m_type_ = 0;
    // m_mode_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@291ae
    m_mode_ = 0;
    // m_flow_control_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@61df66b6
    m_flow_control_ = false;
    // m_forwarding_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@50eac852
    m_forwarding_ = false;
    // m_mavlink_v2_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@16ec5519
    m_mavlink_v2_ = false;
    // m_ftp_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2f7298b
    m_ftp_ = false;
    // m_streams_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@188715b5
    m_streams_ = 0;
    // m_data_rate_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1ea9f6af
    m_data_rate_ = 0.0;
    // m_rate_multiplier_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6a192cfe
    m_rate_multiplier_ = 0.0;
    // m_tx_rate_avg_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5119fb47
    m_tx_rate_avg_ = 0.0;
    // m_tx_error_rate_avg_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7193666c
    m_tx_error_rate_avg_ = 0.0;
    // m_tx_message_count_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@20deea7f
    m_tx_message_count_ = 0;
    // m_tx_buffer_overruns_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3835c46
    m_tx_buffer_overruns_ = 0;
    // m_rx_rate_avg_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1dde4cb2
    m_rx_rate_avg_ = 0.0;
    // m_rx_message_count_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@393671df
    m_rx_message_count_ = 0;
    // m_rx_message_lost_count_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1afd44cb
    m_rx_message_lost_count_ = 0;
    // m_rx_buffer_overruns_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6973b51b
    m_rx_buffer_overruns_ = 0;
    // m_rx_parse_errors_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1ab3a8c8
    m_rx_parse_errors_ = 0;
    // m_rx_packet_drop_count_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@43195e57
    m_rx_packet_drop_count_ = 0;
    // m_rx_message_lost_rate_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@333291e3
    m_rx_message_lost_rate_ = 0.0;
    // m_heartbeat_type_antenna_tracker_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@479d31f3
    m_heartbeat_type_antenna_tracker_ = false;
    // m_heartbeat_type_gcs_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@40ef3420
    m_heartbeat_type_gcs_ = false;
    // m_heartbeat_type_onboard_controller_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@498d318c
    m_heartbeat_type_onboard_controller_ = false;
    // m_heartbeat_type_gimbal_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6e171cd7
    m_heartbeat_type_gimbal_ = false;
    // m_heartbeat_type_adsb_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@402bba4f
    m_heartbeat_type_adsb_ = false;
    // m_heartbeat_type_camera_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@795cd85e
    m_heartbeat_type_camera_ = false;
    // m_heartbeat_type_parachute_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@59fd97a8
    m_heartbeat_type_parachute_ = false;
    // m_heartbeat_component_telemetry_radio_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@f5ac9e4
    m_heartbeat_component_telemetry_radio_ = false;
    // m_heartbeat_component_log_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@123ef382
    m_heartbeat_component_log_ = false;
    // m_heartbeat_component_osd_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@dbf57b3
    m_heartbeat_component_osd_ = false;
    // m_heartbeat_component_obstacle_avoidance_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@384ad17b
    m_heartbeat_component_obstacle_avoidance_ = false;
    // m_heartbeat_component_vio_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@61862a7f
    m_heartbeat_component_vio_ = false;
    // m_heartbeat_component_pairing_manager_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@441772e
    m_heartbeat_component_pairing_manager_ = false;
    // m_heartbeat_component_udp_bridge_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7334aada
    m_heartbeat_component_udp_bridge_ = false;
    // m_heartbeat_component_uart_bridge_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1d9b7cce
    m_heartbeat_component_uart_bridge_ = false;
    // m_avoidance_system_healthy_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4d9e68d0
    m_avoidance_system_healthy_ = false;
    // m_parachute_system_healthy_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@42e99e4a
