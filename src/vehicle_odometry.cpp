...
{
    // m_timestamp_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6c1a5b54
    m_timestamp_ = 0;
    // m_timestamp_sample_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1c7696c6
    m_timestamp_sample_ = 0;
    // m_pose_frame_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@60099951
    m_pose_frame_ = 0;
    // m_position com.eprosima.idl.parser.typecode.AliasTypeCode@20140db9
    memset(&m_position, 0, (3) * 4);
    // m_q com.eprosima.idl.parser.typecode.AliasTypeCode@1e6a3214
    memset(&m_q, 0, (4) * 4);
    // m_velocity_frame_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@368247b9
    m_velocity_frame_ = 0;
    // m_velocity com.eprosima.idl.parser.typecode.AliasTypeCode@20140db9
    memset(&m_velocity, 0, (3) * 4);
    // m_angular_velocity com.eprosima.idl.parser.typecode.AliasTypeCode@20140db9
    memset(&m_angular_velocity, 0, (3) * 4);
    // m_position_variance com.eprosima.idl.parser.typecode.AliasTypeCode@20140db9
    memset(&m_position_variance, 0, (3) * 4);
    // m_orientation_variance com.eprosima.idl.parser.typecode.AliasTypeCode@20140db9
    memset(&m_orientation_variance, 0, (3) * 4);
    // m_velocity_variance com.eprosima.idl.parser.typecode.AliasTypeCode@20140db9
    memset(&m_velocity_variance, 0, (3) * 4);
    // m_reset_counter_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1a6d8329
    m_reset_counter_ = 0;
    // m_quality_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1a942c18
    m_quality_ = 0;
