...
{
    // m_timestamp_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@ba2f4ec
    m_timestamp_ = 0;
    // m_gyro_rad com.eprosima.idl.parser.typecode.AliasTypeCode@1c1bbc4e
    memset(&m_gyro_rad, 0, (3) * 4);
    // m_gyro_integral_dt_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@55fe41ea
    m_gyro_integral_dt_ = 0;
    // m_accelerometer_timestamp_relative_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@fbd1f6
    m_accelerometer_timestamp_relative_ = 0;
    // m_accelerometer_m_s2 com.eprosima.idl.parser.typecode.AliasTypeCode@1c1bbc4e
    memset(&m_accelerometer_m_s2, 0, (3) * 4);
    // m_accelerometer_integral_dt_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7a8c8dcf
    m_accelerometer_integral_dt_ = 0;
    // m_accelerometer_clipping_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@24269709
    m_accelerometer_clipping_ = 0;
    // m_gyro_clipping_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2aceadd4
    m_gyro_clipping_ = 0;
    // m_accel_calibration_count_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@24aed80c
    m_accel_calibration_count_ = 0;
    // m_gyro_calibration_count_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3a52dba3
